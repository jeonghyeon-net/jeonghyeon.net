...
이 숫자가 의미하는 바를 계산해보자. 쓰기 quorum과 읽기 quorum의 합이 복사본 수보다 커야 읽기에서 항상 최신 데이터를 포함하게 된다: 4 + 3 = 7 > 6. 따라서 읽기 quorum 3개 중 최소 1개는 반드시 최신 쓰기를 포함한다.
...
스토리지 노드가 redo log record를 받은 후 어떤 일이 일어나는지 살펴보자.
